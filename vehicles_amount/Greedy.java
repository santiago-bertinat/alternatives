...
public class Greedy {
  ...
  public static void main(String[] args) {
    ...
    saveResults("alternatives/vehicles_amount/results/greedy_qos_results.txt");
    saveResultsForAE();
    ...
    saveResults("alternatives/vehicles_amount/results/greedy_cost_results.txt");
    saveResultsForAE();
  }
  ...
  private static void saveResultsForAE() {
    try {
      ...
      BufferedWriter buffer_initializations = new BufferedWriter(new FileWriter("alternatives/vehicles_amount/results/greedy_AE_format.txt", true));
      BufferedWriter buffer_results = new BufferedWriter(new FileWriter("alternatives/vehicles_amount/results/greedy_objectives_results.txt", true));
